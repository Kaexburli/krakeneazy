module.exports = {
  ...
  deploy: {
    preprod: {
      ...
      npm run build; \
      cd ../; \
      pm2 startOrRestart ecosystem.config.js --wait-ready --listen-timeout 10000 --env preprod;",
    },
    production: {
      user: "websitedev",
      host: ["212.227.212.129"],
      ...
      rm -rf deploy; \
      pm2 flush; \
      pm2 startOrRestart ecosystem.config.js --wait-ready --listen-timeout 10000;",
    },
  }
};