...
const closeWorker = () => {
  ...
  worker.postMessage({
    command: 'disconnect',
    message: '[WSTRADE] Call websocket connect.',
    wssurl: wss_trade
  });
